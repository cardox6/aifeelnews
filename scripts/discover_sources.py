...
SEARCH_TERMS = [
    ...
    "technology", "tech", "ai", "startup",
    "world", "international", "global", "security",
    "society", "justice", "equality", "social", "immigration", "refugees",
    "environment", "climate", "sustainability", "nature",
    "history", "archaeology", "anthropology", "culture",

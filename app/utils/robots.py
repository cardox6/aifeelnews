            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    try:
                        ...
                        rp.read()
                        logger.info(f"Successfully parsed robots.txt for {domain} via HTTP")
                        return rp
                    finally:
                        os.unlink(tmp_file_path)
...
def is_url_allowed(url: str, user_agent: str = USER_AGENT) -> Tuple[bool, Optional[str]]:
    """
...
def respect_crawl_delay(domain: str, last_crawl_time: Optional[datetime] = None) -> bool:
    """
